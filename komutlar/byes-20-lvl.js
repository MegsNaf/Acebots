...
exports.run = async (bot, message, args) => {
  ...
  var embed = new Discord.MessageEmbed()
    ...
    .addField("Verilen Rol", "`🏆altın brawler |20 level|`");
  ...
  message.channel.send(
    new Discord.MessageEmbed()
      .setDescription(
        `${rMember} isimli üyeye  \`🏆altın brawler |20 level|\` isimli yetki başarıyla verildi! :white_check_mark:`
      )
