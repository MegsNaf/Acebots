...
exports.run = async (bot, message, args) => {
  ...
  var embed = new Discord.MessageEmbed()
    ...
    .addField("Verilen Rol", "`🛩 Gökyüzü brawler |15 level|`");
  ...
  message.channel.send(
    new Discord.MessageEmbed()
      .setDescription(
        `${rMember} isimli üyeye  \`🛩 Gökyüzü brawler |15 level|\` isimli yetki başarıyla verildi! :white_check_mark:`
      )
